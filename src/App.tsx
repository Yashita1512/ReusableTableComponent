...
const Content: React.FC = () => {
  ...
  return (
    <div className='h-screen flex flex-col justify-center'>
      ...
      <Routes>
        <Route path="/example1" element={<Page heading={"NPATG-Game"} heading_arr={NPATG_headings} data_arr={NPATG_data} />} />
        <Route path="/example2" element={<Page heading={"Customer-Data"} heading_arr={Customer_headings} data_arr={Customer_data} />} />
        <Route path="/example3" element={<Page heading={"Product-Data"} heading_arr={Product_headings} data_arr={Product_data} />} />
      </Routes>
    </div>
  );
};
