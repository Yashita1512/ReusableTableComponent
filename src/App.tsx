...
const Content: React.FC = () => {
  ...
  return (
    <div className='h-screen flex flex-col justify-center'>
      ...
      {location.pathname === "https://yashita1512.github.io/ReusableTableComponent/" && <p className="text-xl text-center">Click on one of the examples to see the corressponding tables</p>} 
